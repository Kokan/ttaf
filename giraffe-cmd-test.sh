...
ls -1 ../ttaf2/a/misc/* > testimages/out/misc/list
...
./giraffe-cmd.sh -i ../ttaf2/LC08_L1TP_188027_20200420_20200508_01_T1.tif -o testimages/out/valami-rgb-normalized-kmeans.tiff -a k-means -e --min 2 --max 10 --image-transform "select(1,2,3)" --image-transform "normalize-variance(3.0)" --mask 1851,4,14,6256,14,6256,6119,8066,6119,8066,7964,1786,7964,1786,1851,4
./giraffe-cmd.sh -i ../ttaf2/LC08_L1TP_188027_20200420_20200508_01_T1.tif -o testimages/out/valami-rgb-hyper-hue-normalized-kmeans.tiff -a k-means -e --min 2 --max 10 --image-transform "select(1,2,3)" --image-transform "normalize-variance(3.0)" --image-transform hyper-hue --mask 1851,4,14,6256,14,6256,6119,8066,6119,8066,7964,1786,7964,1786,1851,4
./giraffe-cmd.sh -i ../ttaf2/LC08_L1TP_188027_20200420_20200508_01_T1.tif -o testimages/out/valami-all-hyper-hue-normalized-kmeans.tiff -a k-means -e --min 2 --max 10 --image-transform "normalize-variance(3.0)" --image-transform hyper-hue --mask 1851,4,14,6256,14,6256,6119,8066,6119,8066,7964,1786,7964,1786,1851,4
./giraffe-cmd.sh -i ../ttaf2/LC08_L1TP_188027_20200420_20200508_01_T1.tif -o testimages/out/valami-nir-red-kmeans.tiff -a k-means -e --min 2 --max 10 --image-transform "select(3,4)" --mask 1851,4,14,6256,14,6256,6119,8066,6119,8066,7964,1786,7964,1786,1851,4
./giraffe-cmd.sh -i ../ttaf2/LC08_L1TP_188027_20200420_20200508_01_T1.tif -o testimages/out/valami-ndvi-kmeans.tiff -a k-means -e --min 2 --max 10 --image-transform "select(3,4)" --image-transform normalized-difference-vegetation-index --mask 1851,4,14,6256,14,6256,6119,8066,6119,8066,7964,1786,7964,1786,1851,4
./giraffe-cmd.sh -i ../ttaf2/LC08_L1TP_188027_20200420_20200508_01_T1.tif -o testimages/out/valami-nir-red-normalized-hyper-hue-kmeans.tiff -a k-means -e --min 2 --max 3 --image-transform "select(3,4)" --image-transform "normalized-hyper-hue(0.01)" --mask 1851,4,14,6256,14,6256,6119,8066,6119,8066,7964,1786,7964,1786,1851,4
