...
./giraffe-cmd.sh -i ../ttaf2/huetest1.tiff -o ../ttaf2/testout/huetest1-otsu-circular.tiff -a otsu-circular -e=false --min 2 --max 2 --bins 100 --image-transform hue
./giraffe-cmd.sh -i ../ttaf2/huetest1.tiff -o ../ttaf2/testout/huetest1-otsu-linear.tiff -a otsu -e=false --min 2 --max 2 --bins 100 --image-transform hue
./giraffe-cmd.sh -i ../ttaf2/huetest2.tiff -o ../ttaf2/testout/huetest2-otsu-circular.tiff -a otsu-circular -e=false --min 2 --max 2 --bins 100 --image-transform hue
./giraffe-cmd.sh -i ../ttaf2/huetest2.tiff -o ../ttaf2/testout/huetest2-otsu-linear.tiff -a otsu -e=false --min 2 --max 2 --bins 100 --image-transform hue
